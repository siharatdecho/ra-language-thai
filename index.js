module.exports = {
    ra: {
        ...
        input: {
            file: {
                upload_several:
                    'วางไฟล์ที่ต้องการอัปโหลดหรือคลิกเพื่อเลือก',
                upload_single: 'วางไฟล์ที่ต้องการอัปโหลดหรือคลิกเพื่อเลือก',
            },
            image: {
                upload_several:
                    'วางรูปภาพที่ต้องการอัปโหลดหรือคลิกเพื่อเลือก',
                upload_single:
                    'วางรูปภาพที่ต้องการอัปโหลดหรือคลิกเพื่อเลือก'
            },
            references: {
                ...
                many_missing:
                    'การอ้างอิงที่เกี่ยวข้องอย่างน้อยหนึ่งรายการไม่มีข้อมูล',
                single_missing:
                    'ไม่มีข้อมูลอ้างอิงที่เกี่ยวข้อง',
            },
            password: {
        ...
        message: {
            ...
            bulk_delete_content:
                'คุณแน่ใจหรือไม่ว่าต้องการลบ %{name}? |||| คุณแน่ใจหรือไม่ว่าต้องการลบข้อมูลทั้ง %{smart_count} รายการ?',
            bulk_delete_title:
                'ลบ %{name} |||| ลบ %{smart_count} %{name}',
            delete_content: 'คุณแน่ใจหรือไม่ว่าต้องการลบสิ่งนี้?',
            delete_title: 'ลบ %{name} #%{id}',
            details: 'รายละเอียด',
            error:
                "เกิดข้อผิดพลาดของ client ไม่สามารถดำเนินการตาม request ได้",
            invalid_form: 'แบบฟอร์มไม่ถูกต้อง โปรดตรวจสอบข้อผิดพลาด',
            loading: 'กำลังโหลด โปรดรอสักครู่',
            no: 'ไม่',
            not_found:
                'พิมพ์ URL ผิดหรือเข้าลิงก์ที่ไม่ถูกต้อง',
            yes: '네',
            unsaved_changes:
                "ยังไม่ได้บันทึกการเปลี่ยนแปลงข้อมูล คุณแน่ใจหรือไม่ที่จะละทิ้ง?",
        },
        navigation: {
            no_results: 'ไม่พบผลลัพธ์ที่ค้นหา',
            no_more_results:
                'จำนวนหน้า %{page} เกินจำนวนหน้าทั้งหมด',
        ...
        notification: {
            ...
            http_error: 'เกิดข้อผิดพลาดในการเชื่อมต่อเครือข่าย',
            data_provider_error:
                'dataProvider เกิดข้อผิดพลาด โปรดตรวจสอบรายละเอียดจาก console',
            i18n_error:
                'ไม่สามารถโหลดคำแปลภาษาที่ระบุได้',
            canceled: 'ยกเลิกการดำเนินการ',
            logged_out: 'session หมดอายุ โปรดเชื่อมต่ออีกครั้ง',
        },
        validation: {
            required: 'จำเป็น',
